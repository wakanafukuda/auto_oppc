...
int main(int argc, char** argv)
{
  ...
  ros::NodeHandle nh;
    ...
    cv_image1.image = cv::imread("/home/rodepoppc/catkin_ws/src/image_pub/include/image_pub/image1.jpeg",CV_LOAD_IMAGE_COLOR);
    cv_image2.image = cv::imread("/home/rodepoppc/catkin_ws/src/image_pub/include/image_pub/image2.jpg",CV_LOAD_IMAGE_COLOR);
  ...
  while (nh.ok()) //nodeがシャットダウンされないときループを続ける
  {
    for(int i = 0; i < 100; i++) {
